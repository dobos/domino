Type.registerNamespace("Domino");

Domino.CodeMirror = function (element, indentUnit, lineNumbers, matchBrackets, mode, theme, width, height) {
    Domino.CodeMirror.initializeBase(this, [element]);
...
Domino.CodeMirror.prototype = {
    initialize: function () {
        Domino.CodeMirror.callBaseMethod(this, "initialize");
    ...
    dispose: function () {
        Domino.CodeMirror.callBaseMethod(this, 'dispose');
    },
...
Domino.CodeMirror.registerClass('Domino.CodeMirror', Sys.UI.Behavior);
